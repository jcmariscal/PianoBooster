...
public:
    ...
    static void setSplitHandsMode(splitHandsMode_t mode)
    {
        if (mode < PB_SPLIT_HANDS_naive || mode > PB_SPLIT_HANDS_createChannels)
            mode = PB_SPLIT_HANDS_naive;
        m_splitHandsMode = mode;
    }
